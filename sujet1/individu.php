    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-2 text-gray-800">Questionnaire Individus/Ménages</h1>
            <p class="mb-4">Cette page contient un ensemble de sondages sur les différents individus et ménages insulaires.</p>
                <!-- Card Body -->
                <!-- <div class="card-body">
