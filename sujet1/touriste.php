      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <h1 class="h3 mb-2 text-gray-800">Questionnaire Objets touristiques</h1>
            <p class="mb-4">Cette page contient un ensemble de sondages sur les objets touristiques de l'ile.</p>
